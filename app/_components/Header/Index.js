        ...
        <header onMouseEnter={onEnter} onMouseLeave={onLeave} ref={ref} className={`${styles.container} shadow-lg py-2 fixed left-0 top-0 right-0 z-10 max-md:h-[70px] overflow-hidden max-md:bg-white max-md:bottom-0 max-md:flex max-md:flex-col max-md-justify-center max-md:items-start`}>
            ...
            <div ref={ref_} className='max-md:hidden flex justify-center items-start max-md:m-auto max-md:flex-col max-md-justify-start max-md:items-start max-md:[&>a]:mb-5' >
                ...
                <Link onClick={() => handleClickClose()} className='flex flex-col max-md:items-start justify-center items-center m-link min-w-[120px]' href={"/ev"} >
                    <Image className={`m-auto max-w-[50px] ${styles.fimg}`} src={pathname == "/ev" ? home : home_} />
                    <Image className={`m-auto max-w-[50px] hidden ${styles.simg}`} src={home} />
                    <div className='menu-item md:absolute md:top-[65%] text-sx' >
                ...
                <Link onClick={() => handleClickClose()} className='flex flex-col max-md:items-start justify-center items-center m-link min-w-[120px]' href={"/isyeri"}>
                    <Image className={`m-auto max-w-[50px] ${styles.fimg}`} src={pathname == "/isyeri" ? company : company_} />
                    <Image className={`m-auto max-w-[50px] hidden ${styles.simg}`} src={company} />
                    <div className='menu-item md:absolute md:top-[65%] text-sx'>
                ...
                <Link onClick={() => handleClickClose()} className='flex flex-col max-md:items-start justify-center items-center m-link min-w-[120px]' href={"/seyahat"}>
                    <Image className={`m-auto max-w-[50px] ${styles.fimg}`} src={pathname == "/seyahat" ? trip : trip_} />
                    <Image className={`m-auto max-w-[50px] hidden ${styles.simg}`} src={trip} />
                    <div className='menu-item md:absolute md:top-[65%] text-sx'>
                ...
                <Link onClick={() => handleClickClose()} className='flex flex-col max-md:items-start justify-center items-center m-link min-w-[120px]' href={"/saglik"} >
                    <Image className={`m-auto max-w-[50px] ${styles.fimg}`} src={pathname == "/saglik" ? heart : heart_} />
                    <Image className={`m-auto max-w-[50px] hidden ${styles.simg}`} src={heart} />
