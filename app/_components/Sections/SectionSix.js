...
function SectionSix() {
    ...
    return (
        <section id='form' className='md:min-h-[900px]  max-md:my-4 mb-10 form md:w-[100vw] md:h-[100vh] md:px-[50px] lg:px[200px] 2xl:px-[250px] max-md:pb-[50px] md:pt-[100px] flex flex-col justify-start items-center form_' >
