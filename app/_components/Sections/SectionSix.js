...
function SectionSix() {
    ...
    return (
        <section id='form' className='md:pt-[100px] max-md:my-4 mb-10  form md:w-[100vw] md:px-[50px] lg:px[200px] 2xl:px-[250px] max-md:pb-[30px] max-md:pt-[10px] flex flex-col justify-start items-center form_' >
