...
function SectionThree() {
    return (
        <section className='md:h-[100vh] w-[100vw] pt-[120px] max-md:py-[25px] px-[25px] lg:px-[200px] xl:px-[300px] flex flex-col justify-start items-center relative max-md:bg-slate-50' >
