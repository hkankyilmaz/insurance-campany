    ...
    return (
        <>
            <div className='flex flex-col justify-center items-center'>
                ...
                <div className='[&>p]:mb-3 max-w-[1200px] max-md:[&>p]:text-xs  flex flex-col justify-start items-start z-10 shadow-xl px-10 py-12 rounded-2xl translate-y-[-100px] bg-white' >
                    ...
                    <p>  <strong>e-sigortam.com</strong> binlerce müşteriye en iyi fiyat ve en iyi teminatlarla kaliteli sigortacılık hizmeti sunmayı sürdürmektedir. </p>
                    <p>Sunduğumuz kesintisiz hizmet sayesinde müşterilerimiz ne zaman ve nerede ihtiyaç duyarsa bize ulaşabilirler.</p>
                    <p>  <strong>e-sigortam.com</strong> da ‘’sadece müşterinin temsilcisi olmak” şirket kültürünün bir parçasıdır. Bu nedenle müşterilerimizin ihtiyaçlarını anında çözüme ulaştırmak bizim en büyük hedefimizdir.</p>
                    ...
                    <br />
                    <p> <strong>e-sigortam.com, bir Arıcıoğlu kuruluşudur.</strong> </p>
