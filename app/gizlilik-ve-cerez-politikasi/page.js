        ...
        <main className='flex justify-center items-start pt-[100px] pb-[100px] max-lg:px-7'>
            ...
            <div className='max-w-[1000px] grid grid-cols-1 gap-2' >
                ...
                <div className='grid grid-cols-1 gap-4'>
                    ...
                    <br />
                    <p>
                        www.akdagcisigorta.com üyelik iptal işleminizi info@akdagcisigorta.com adresine email göndererek veya
                    </p>
                    <p>
                        www.akdagcisigorta.com’ye aşağıda yer alan iletişim bilgilerinden ulaşabilirsiniz.
                    </p>

                    <p>
                        Ayhan Akdağcı Sigorta
                    </p>
                    <p>
                        Adres : Kemaliye, Muammer Sencer Cd. No:60E, 54300 Hendek/Sakarya
                    </p>
                    <p>
                        Telefon: +90 (533) 155 5516
                    </p>
                    <br />
                    <p>
                        Ayhan Akdağcı Sigorta, kullanıcılara ve kullanıcıların www.akdagcisigorta.com sitesinin kullanımına dair bilgileri, teknik bir iletişim dosyasını (Kurabiye-Cookie) kullanarak elde edebilir. Ancak, kullanıcılar dilerlerse teknik iletişim dosyasının gelmemesi veya teknik iletişim dosyası gönderildiğinde ikaz verilmesini sağlayacak biçimde tarayıcı ayarlarını değiştirebilirler.
                    </p>
                </div>
            </div>
